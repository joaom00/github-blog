  ...
  return (
    <svg width="1em" height="1em" viewBox="0 0 32 32" {...props}>
      <g fill="none">
        ...
        ></path>
        <path fill="#9B9B9B" d="M24.528 11.25a3.25 3.25 0 1 1-6.5 0a3.25 3.25 0 0 1 6.5 0Z"></path>
        <path fill="#83CBFF" d="M23.528 11.25a2.25 2.25 0 1 1-4.5 0a2.25 2.25 0 0 1 4.5 0Z"></path>
        <path
          fill="#FF8257"
